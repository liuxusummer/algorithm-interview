...
title: 华为研发岗 2026-04-08
description: 华为 2026-04-08 研发岗笔试真题，含 3 道 Python ACM 模式题解
---

<div class="exam-session-banner">
  <div>
    <span>HUAWEI / 2026.04.08 / ACM</span>
    <strong>华为 · 研发岗</strong>
    <small>2026-04-08 · 3 题 ACM · 难度 困难</small>
  </div>
  <div class="exam-session-banner__meta">
    <span>混合进制编码 + 中心扩展法求最长回文子串</span>
    <span>贪心 + 大顶堆</span>
    <span>状态压缩 DP + 子集枚举</span>
  </div>
</div>

# 华为 2026-04-08 研发岗笔试解析

本场仅整理需要编程实现的题目，并统一为完整 Python ACM 程序。每题保留标准输入输出、解题依据、关键实现、复杂度与中文注释；AI 岗的选择题不混入本模块。

来源：[Zero2Leetcode · 华为 2026-04-08 研发岗](https://onefly.top/zero2Leetcode/04_real_interviews/huawei/dev-20260408/)。
...
# 核心步骤：混合进制编码 + 中心扩展法求最长回文子串；按题意读取标准输入并输出结果。
...
# 核心步骤：状态压缩 DP + 子集枚举；按题意读取标准输入并输出结果。
