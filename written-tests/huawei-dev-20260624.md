...
title: 华为研发岗（通软、嵌软、测试、普通算法、数据科学等非AI方向） 2026-06-24
description: 华为 2026-06-24 研发岗（通软、嵌软、测试、普通算法、数据科学等非AI方向）笔试真题，含 3 道 Python ACM 模式题解
---

<div class="exam-session-banner">
  <div>
    <span>HUAWEI / 2026.06.24 / ACM</span>
    <strong>华为 · 研发岗（通软、嵌软、测试、普通算法、数据科学等非AI方向）</strong>
    <small>2026-06-24 · 3 题 ACM · 难度 中等</small>
  </div>
  <div class="exam-session-banner__meta">
    <span>电影放映调度</span>
    <span>快来排队买包子</span>
    <span>容器镜像 Top-K 大小统计</span>
  </div>
</div>

# 华为 2026-06-24 研发岗（通软、嵌软、测试、普通算法、数据科学等非AI方向）笔试解析

本场仅整理需要编程实现的题目，并统一为完整 Python ACM 程序。每题保留标准输入输出、解题依据、关键实现、复杂度与中文注释；AI 岗的选择题不混入本模块。

来源：[Zero2Leetcode · 华为 2026-06-24 研发岗（通软、嵌软、测试、普通算法、数据科学等非AI方向）](https://onefly.top/zero2Leetcode/04_real_interviews/huawei/dev-20260624/)。
...
```python
# 核心步骤：容器镜像 Top-K 大小统计；按题意读取标准输入并输出结果。
import sys
