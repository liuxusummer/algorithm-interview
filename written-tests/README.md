...
本站对全部 **109 场笔试、318 道算法题**做了统一统计，包含难度分布、算法频次、常见算法组合、公司侧重点、岗位差异和四周备考计划。
...
- [蚂蚁 AI Coding · 终端早餐店系统](./ant-20260329-ai-coding)
- [百度研发岗综合卷 · Prompt 与分期借贷还款引擎](./baidu-dev-20260730)
...
| 项目 | 统一要求 |
|---|---|
| 输入 | 与原场次保持一致；107 场非 AI Coding 笔试均提供完整 `stdin` 读取流程 |
