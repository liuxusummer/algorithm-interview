...
title: 字节跳动通用技术岗 2026-04-19
description: 字节跳动 2026-04-19 通用技术岗笔试真题，含 4 道 Python ACM 模式题解
---

<div class="exam-session-banner">
  <div>
    <span>BYTEDANCE / 2026.04.19 / ACM</span>
    <strong>字节跳动 · 通用技术岗</strong>
    <small>2026-04-19 · 4 题 ACM · 难度 中等</small>
  </div>
  <div class="exam-session-banner__meta">
    <span>二分答案 + 贪心</span>
    <span>贪心标记 + 相邻性验证</span>
    <span>贪心 + 因子分解</span>
    <span>矩阵模拟</span>
  </div>
</div>

# 字节跳动 2026-04-19 通用技术岗笔试解析

本场统一整理为完整 Python 3 ACM 程序。每题保留标准输入输出、建模过程、正确性依据、复杂度、易错点和关键中文注释；原 SQL、Shell 与第三方机器学习库题也已改写为可独立运行的标准库版本。

来源：[Zero2Leetcode · 字节跳动 2026-04-19 通用技术岗](https://onefly.top/zero2Leetcode/04_real_interviews/bytedance/general-20260419/)。
...
```python
# 核心步骤：贪心标记 + 相邻性验证；严格按题面处理边界并输出结果。
import sys
input = sys.stdin.readline
