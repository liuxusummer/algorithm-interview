...
title: 华为留学生非AI岗（研发） 2026-04-23
description: 华为 2026-04-23 留学生非AI岗（研发）笔试真题，含 3 道 Python ACM 模式题解
---

<div class="exam-session-banner">
  <div>
    <span>HUAWEI / 2026.04.23 / ACM</span>
    <strong>华为 · 留学生非AI岗（研发）</strong>
    <small>2026-04-23 · 3 题 ACM · 难度 中等</small>
  </div>
  <div class="exam-session-banner__meta">
    <span>字符串解析 + 自定义排序</span>
    <span>Floyd-Warshall 全源最短路</span>
    <span>完全背包计数 DP</span>
  </div>
</div>

# 华为 2026-04-23 留学生非AI岗（研发）笔试解析

本场仅整理需要编程实现的题目，并统一为完整 Python ACM 程序。每题保留标准输入输出、解题依据、关键实现、复杂度与中文注释；AI 岗的选择题不混入本模块。

来源：[Zero2Leetcode · 华为 2026-04-23 留学生非AI岗（研发）](https://onefly.top/zero2Leetcode/04_real_interviews/huawei/dev-20260423/)。
...
# 核心步骤：字符串解析 + 自定义排序；按题意读取标准输入并输出结果。
...
## 02 · AI 超节点内部计算单元通信最小时延 {#problem-02}
