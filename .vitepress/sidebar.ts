...
export const sidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '110 平衡二叉树', link: '/problems/110-balanced-binary-tree' },
      { text: '112 路径总和', link: '/problems/112-path-sum' },
      { text: '113 路径总和 II', link: '/problems/113-path-sum-ii' },
      ...
      { text: '129 求根节点到叶节点数字之和', link: '/problems/129-sum-root-to-leaf-numbers' },
      ...
      { text: '144 二叉树的前序遍历', link: '/problems/144-binary-tree-preorder-traversal' },
      { text: '145 二叉树的后序遍历', link: '/problems/145-binary-tree-postorder-traversal' },
      { text: '146 LRU 缓存', link: '/problems/146-lru-cache' },
      { text: '148 排序链表', link: '/problems/148-sort-list' },
      { text: '151 反转字符串中的单词', link: '/problems/151-reverse-words-in-a-string' },
      ...
      { text: '162 寻找峰值', link: '/problems/162-find-peak-element' },
      ...
      { text: '208 实现 Trie（前缀树）', link: '/problems/208-implement-trie-prefix-tree' },
      ...
      { text: '227 基本计算器 II', link: '/problems/227-basic-calculator-ii' },
      ...
      { text: '297 二叉树的序列化与反序列化', link: '/problems/297-serialize-and-deserialize-binary-tree' },
      ...
      { text: '518 零钱兑换 II', link: '/problems/518-coin-change-ii' },
      ...
      { text: '剑指 Offer 51 数组中的逆序对', link: '/problems/offer-051-reverse-pairs' },
      {
        text: '原创面试题',
        collapsed: true,
        items: [
